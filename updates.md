...
> **Total de linhas:** *`3255`*<br>
> **Datado de:** *`2025-07-23 -> 2026-03-17`*
...
### Mudanças
- Então, por causa das configurações, várias **Funções JS** e variáveis poderão ser mudadas conforme o que o usuário quiser
- A opção *Sair* dos Menus foi alterada para *Voltar ao menu principal*. E só há *Sair* nos menus do menu principal
...
- O menu das configurações tem páginas e *Avançar página* e *Voltar página*

### Correções
- Corrigidas algumas falhas técnicas, tais como a adição de `N/A` ao fim dos arrays do menu permanentemente
...
### Adições
- Adicionadas também variáveis para as **Funções Logarítmicas**
...
- Padronização nas opções globais dos Menus *(quando aplicável)*, para que fiquem mais intuitivas *(Pois, se fosse um menu interativo, a opção de **Próxima** estaria à direita e **Anterior**, à esquerda)*
...
### Mudanças
- Foram mudadas algumas mensagens por causa da padronização
- Melhorias em partes do código
