...
export const Commands = {
    ...
    process(raw = "") {
        ...
        if (canonical == null) {
            ...
            Ui.error(tr("Comando inválido", "Invalid command"), "“/" +
                cmd +
                "” " +
    ...
    listCmd() {
        return {
            help: {
                ...
                long: tr("Exibe a lista de todos os comandos disponíveis.\nUse: /ajuda [comando]", "Displays the list of all available commands.\nUsage: /help [command]"),
            ...
            search: {
                ...
                long: tr("Pesquisa comandos por termo no nome, variações e descrições.\nUse: /pesquisa <termo>", "Searches commands by term in name, variations and descriptions.\nUsage: /search <term>"),
            ...
            shortcuts: {
                ...
                long: tr("Exibe todas as variações aceitas de um comando.\nUse: /atalhos <comando>", "Displays all accepted variations of a command.\nUsage: /shortcuts <command>"),
            ...
            reset: {
                ...
                long: tr("Remove as configurações salvas e restaura os valores padrão.", "Removes saved settings and restores default values."),
                variations: ["resetar", "reset", "restaurar", "restore"],
                action() {
                    resetConfig();
                    Ui.warning(tr("Configurações restauradas para os valores padrão.", "Settings restored to default values."));
                    return null;
                },
            },
            start: {
                short: tr("volta ao menu principal", "returns to main menu"),
                long: tr("Retorna ao menu inicial de seleção de função.", "Returns to the initial function selection menu."),
            ...
            review: {
                ...
                long: tr("Exibe os coeficientes inseridos na sessão atual.", "Displays the coefficients entered in the current session."),
            ...
            change: {
                ...
                long: tr("Permite alterar os coeficientes sem reiniciar a análise.", "Allows changing coefficients without restarting the analysis."),
            ...
            history: {
                ...
                long: tr("Exibe o histórico de funções analisadas na sessão.", "Displays the history of functions analyzed in the session."),
            ...
            version: {
                ...
                long: tr("Exibe a versão atual do programa e informações de autoria.", "Displays the current version of the program and authorship information."),
            ...
            unicode: {
                ...
                long: tr("Ativa ou desativa o uso de caracteres Unicode na saída.", "Enables or disables the use of Unicode characters in output."),
            ...
            accents: {
                ...
                long: tr("Ativa ou desativa acentos nas mensagens exibidas.", "Enables or disables accents in displayed messages."),
            ...
            explain: {
                ...
                long: tr("Ativa ou desativa as explicações detalhadas dos resultados.", "Enables or disables detailed explanations of results."),
            ...
            capitalize: {
                ...
                long: tr("Ativa ou desativa a capitalização das primeiras letras.", "Enables or disables capitalization of first letters."),
            ...
            separator: {
                ...
                long: tr("Alterna o separador decimal entre ponto e vírgula.", "Toggles the decimal separator between period and comma."),
            ...
            multiples: {
                ...
                long: tr("Ativa ou desativa a simplificação de múltiplos.", "Enables or disables simplification of multiples."),
            ...
            confirm: {
                ...
                long: tr("Ativa ou desativa as confirmações ao inserir dados.", "Enables or disables confirmations when entering data."),
            ...
            confirmExit: {
                ...
                long: tr("Ativa ou desativa a confirmação ao sair do programa.", "Enables or disables the confirmation when exiting the program."),
                variations: [
                    "confirmarSaida",
                    "confirmExit",
                    "confirmarsaida",
            ...
            errors: {
                ...
                long: tr("Ativa ou desativa a exibição de mensagens de erro.", "Enables or disables the display of error messages."),
            ...
            function: {
                ...
                long: tr("Ativa ou desativa a exibição da função analisada.", "Enables or disables the display of the analyzed function."),
                variations: [
                    "funcao",
                    "mostrarfuncao",
                    "mostrarFuncao",
            ...
            language: {
                ...
                long: tr("Altera a língua do programa entre português e inglês.\nUse: /language [pt | en]", "Changes the program language between Portuguese and English.\nUsage: /language [pt | en]"),
                variations: [
                    "lingua",
                    "language",
                    "lang",
                ...
                action(arg, parts) {
                    ...
                    if ([
                        ...
                        if (Config.language == "pt") {
                            Ui.warning(tr("A língua já está definida como português.", "The language is already set to Portuguese."));
                        }
                        else {
                            changeLanguage("pt");
                        }
                    ...
                    // Inglês
                        ...
                        if (Config.language == "en") {
                            Ui.warning(tr("A língua já está definida como inglês.", "The language is already set to English."));
                        }
                        else {
                            changeLanguage("en");
                        }
            ...
            exit: {
                ...
                long: tr("Encerra o programa. Confirmação pode ser solicitada.", "Exits the program. Confirmation may be requested."),
