...
export const Error = {
    range(min = 0, max = 1) {
        ...
        const msg = `${tr("ERRO-001: Valor fora do intervalo. Escolha entre", "ERROR-001: Value out of range. Choose between")} ${firstValue} ${tr("e", "and")} ${max}${min == 0 ? tr(" ou 0 para voltar / sair", " or 0 to go back / exit") : ""}`
