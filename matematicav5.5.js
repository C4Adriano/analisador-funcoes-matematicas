    ...
    traduzir(texto = "") {
        ...
        if (config.linguagem == "pt-br") {
            ...
            frasesCompletas = [
                ...
                ["é constante / nula", "is constant / null"],
                ["é afim / linear", "is affine / linear"],
                ["é afim / identidade", "is affine / identity"],
                ["é afim / oposta", "is affine / opposite"],
                ["é quadrática / pura", "is quadratic / pure"],
                ["é quadrática / incompleta (sem termo linear)", "is quadratic / incomplete (no linear term)"],
                ["é quadrática / incompleta (sem termo constante)", "is quadratic / incomplete (no constant term)"],
                ["é exponencial / pura", "is exponential / pure"],
                ["é exponencial / natural", "is exponential / natural"],
                ["é logarítmica / pura", "is logarithmic / pure"],
                ["é logarítmica / natural", "is logarithmic / natural"],
                ["é logarítmica / decimal", "is logarithmic / decimal"],
                ["“ok” = “sim” | “cancelar” = “não”", "“ok” = “yes” | “cancel” = “no”"],
                ["=== erro ===", "=== error ==="],
                ["=== aviso ===", "=== warning ==="],
                ["=== início ===", "=== start ==="],
                ...
                ["erro-002: divisão por zero", "error-002: division by zero"],
                ["erro-003: ultrapassou o limite", "error-003: exceeded the limit"],
                ["erro-004: a função não é", "error-004: the function is not"],
                ["erro-005: a função não é", "error-005: the function is not"],
                ["6 = rever | 7 = alterar | 8 = anterior | 9 = próxima | 0 = voltar", "6 = review | 7 = change | 8 = previous | 9 = next | 0 = back"],
                ["7 = restaurar padrão | 8 = anterior | 9 = próxima | 0 = voltar", "7 = restore defaults | 8 = previous | 9 = next | 0 = back"],
                ["1 = funções polinomiais", "1 = polynomial functions"],
                ["2 = funções não polinomiais", "2 = non-polynomial functions"],
                ["6 = antigas | 7 = configurações | 8 = rever | 9 = alterar | 0 = sair", "6 = history | 7 = settings | 8 = review | 9 = change | 0 = exit"],
                ["1 = função exponencial", "1 = exponential function"],
                ["2 = função logarítmica", "2 = logarithmic function"],
                ["6 = antigas | 7 = configurações | 8 = rever | 9 = alterar | 0 = voltar", "6 = history | 7 = settings | 8 = review | 9 = change | 0 = back"],
                ...
                ["obs.: configurações não são salvas ao fechar", "note: settings are not saved on close"],
                ["obs.₁: isso irá afetar todas as configurações acima", "note 1: this will affect all the settings above"],
                ["obs.₂: essa alteração é permanente", "note 2: this change is permanent"],
                ["obs.₁:", "note 1:"],
                ["obs.₂:", "note 2:"],
                ["obs.₃:", "note 3:"],
                ["obs.:", "note:"],
            ...
            frasesParciais = [
                ...
                ["não são salvas ao fechar", "are not saved when closing"],
                ["não há histórico o suficiente para mudanças", "there is not enough history for changes"],
                ["escrevestes apenas uma função até agora", "you have only written one function so far"],
                ...
                ["exceto o próprio c", "except for c itself"],
                ["ponto mais baixo", "lowest point"],
                ["ponto da raiz", "root point"],
                ["o ponto é sempre", "the point is always"],
                ["entre o vértice", "between the vertex"],
