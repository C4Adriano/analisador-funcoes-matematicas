...
**Objeto**
Uma estrutura **JavaScript** que agrupa **Funções JS** e variáveis relacionadas. Este projeto usa objetos como `config`, `helpers`, `algebra` e `analisar` para organizar o código.
...
**Release**
Uma versão publicada do projeto, marcada com uma tag de versão _(ex.: `v6.0`)_.
